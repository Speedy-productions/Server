...
logBoot('SUPABASE_URL', SUPABASE_URL);
logBoot('HAS_SUPABASE_KEY', SUPABASE_KEY ? 'yes' : 'no');
logBoot('PUBLIC_BASE_URL', PUBLIC_BASE_URL);
logBoot('GOOGLE_CLIENT_ID_LAST6', GOOGLE_CLIENT_ID ? GOOGLE_CLIENT_ID.slice(-6) : 'missing');
...
console.log('[BOOT] Google redirectUri =', `${PUBLIC_BASE_URL}/auth/google/callback`);
